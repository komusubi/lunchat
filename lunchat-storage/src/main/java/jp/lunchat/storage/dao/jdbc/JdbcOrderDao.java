...
public class JdbcOrderDao implements OrderDao {
    ...
    private static final String SELECT_QUERY_BY_USER_AND_DATE = "select " + COLUMNS
                    + " from orders where userId = :userId and date(datetime) = :datetime";
...
//		List<Order> order = template.query(SELECT_QUERY_BY_USER, orderRowMapper, userId);
        List<Order> orders = template.query(SELECT_QUERY_BY_USER,
                        new MapSqlParameterSource().addValue("userId", userId), orderRowMapper);
